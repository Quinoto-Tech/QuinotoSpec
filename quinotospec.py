...
def main():
    ...
    parser.add_argument("--cline", action="store_true", help="Install for Cline (.cline directory)")
    parser.add_argument("--global", dest="global_install", action="store_true", help="Install globally in ~/.config/")
    parser.add_argument("--uninstall", action="store_true", help="Uninstall QuinotoSpec")
