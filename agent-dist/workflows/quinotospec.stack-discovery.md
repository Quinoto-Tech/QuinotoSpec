...
Antes de comenzar, escanea el root y lista todas las carpetas que contienen `/.quinoto-spec/discovery`. Para cada una, lee el campo `**Discovery Date:**` en su `01-stack-profile.md`. Genera el inventario:
...
- Esperar confirmación del usuario:
  ...
  - **Opción B — Consolidar de todas formas**: Continuar con los datos actuales y documentar en `02-overview.md` qué servicios tienen discovery potencialmente desactualizado.
...
Explora el proyecto completo y genera 8 archivos Markdown independientes en `.quinoto-spec/discovery/` con los siguientes nombres EXACTOS:
- 01-stack-profile.md
- 02-overview.md
- 03-architecture.md
...
- Lee todos los `*/.quinoto-spec/discovery/01-stack-profile.md`.
...
### 2) 02-overview.md
- Lee todos los `*/.quinoto-spec/discovery/02-overview.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/03-architecture.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/04-endpoints-and-openapi.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/05-data-and-services.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/06-devops-ci-security.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/07-findings-and-recommendations.md`.
...
- Lee todos los `*/.quinoto-spec/discovery/08-product-and-agreements.md`.
